...
class _SensorDetailsScreenState extends State<SensorDetailsScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.sensor['title'] != "Temperature Exceeds X" &&
        widget.sensor['title'] != "Temperature Exceeds Y") {
      _fetchRecentReadings();
    } else {
      _fetchExceedingReadings();
    }
  }
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : Padding(
              ...
              child: Column(
                children: widget.sensor['title'] != "Temperature Exceeds X" &&
                        widget.sensor['title'] != "Temperature Exceeds Y"
                    ? [
                    ...
                    : [Text(exceedReading.toStringAsFixed(1))],
              ),
            ),
    );
  }
